...
pygame.display.set_caption('Game_sp')
clock = pygame.time.Clock()

path= 'images\\'
#images
carImg = pygame.image.load(path +'car_2.jpg') 
background = pygame.image.load(path+'background.jpg')
Opt = pygame.image.load(path+'Options.jpg')
Intro = pygame.image.load(path+'intro.png')
...
def game_intro():
    ...
    while intro:
        ...
        button("Play ", 150,450,100,50,green,greenish,modes)
...
def carSelect(c =930):
    ...
    while select:
        ...
        carImg1 = pygame.image.load(path+'car_1.jpg')
        carImg2 = pygame.image.load(path+'car_2.jpg')
        carImg3 = pygame.image.load(path+'car_3.jpg')
        
        gameDisplay.blit(carImg1, (150,250))
        gameDisplay.blit(carImg2, (350,250))
        gameDisplay.blit(carImg3, (550,250))

        gsp=  pygame.image.load(path+'gsp.jpg')
...
def car_1():
    ...
    carImg = pygame.image.load(path+'car_1.jpg')
    carSelect(130)
...
def car_3():
    ...
    carImg = pygame.image.load(path+'car_3.jpg')
    carSelect(530)
...
def Help():
    ...
    while Help:
        ...
        button("Back",250,display_width/2 + 100 ,150,50,red,reddish,Options)
        button("Multiplayer",450,display_width/2 +100, 150,50,yellow,yellowish,None)
